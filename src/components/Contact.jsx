      ...
      <div className='container-contact' id='contact'>
        <div className='container-right'>
          <div className='container-left'>
            ...
            <h1>
              Garanta já os serviços da <span>melhor vidraçaria</span> de ósorio!
            </h1>
            <p className='desktop'>
              Preencha os dados ao <span>lado</span> para entrarmos em contato.
            </p>
            <img src='/img/logo/arrow.png' alt='flecha apontando pro lado' className='arrow' />
            <p className='mobile'>
              Preencha os dados <span>abaixo</span> para entrarmos em contato.
            </p>
          </div>
          <form onSubmit={handleSubmit}>
            <div className='input-group'>
              <label htmlFor='name' id='placeholder'>
                Nome:
              </label>
              <input
                type='text'
